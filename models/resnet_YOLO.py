...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.local_layer.add_module('block_1', conv_block(2048, 1024, 3, False, 1))
        ...
        self.convend = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(256, 30, 1, stride=1, padding=0)
        )
        fill_fc_weights(self.convend)
        # self.layer5 = self._make_detnet_layer(in_channels=2048, out_channels=512)
        ...
        ######
        # self.layer5 = self._make_detnet_layer(in_channels=2048, out_channels=512)
        # # self.conv_end1 = nn.Conv2d(2048, 1024, kernel_size=3, stride=1, padding=1, bias=False)
        # # self.bn_end1 = nn.BatchNorm2d(1024)
        # # self.conv_end2 = nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, bias=False)
        # # self.bn_end2 = nn.BatchNorm2d(1024)
        # self.fc1 = nn.Linear(14*14*512, 2048)
        # self.ReLUfc1 = nn.ReLU(True)
        # self.Dropoutfc1 = nn.Dropout()
        # self.fc2 = nn.Linear(2048, 14*14*30)
        ########
